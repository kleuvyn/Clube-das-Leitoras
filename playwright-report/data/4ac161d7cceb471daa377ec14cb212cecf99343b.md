...
- Name: roda-vozes.spec.ts >> roda de vozes page loads and allows adding a participant
- Location: tests/playwright/roda-vozes.spec.ts:3:5
...
Call log:
  - waiting for locator('input[placeholder="digite seu nome..."]')
    ...
    - fill("Vozes Playwright 1777554810196")
