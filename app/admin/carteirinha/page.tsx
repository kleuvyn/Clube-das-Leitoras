  ...
  return (
    <div className="max-w-6xl mx-auto p-6 md:p-12 space-y-8 font-sans">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full">
        <div className="flex flex-1 flex-col sm:flex-row items-stretch gap-2 rounded-xl border border-slate-200 bg-white p-2 shadow-sm">
          <input
            type="text"
            value={searchTerm}
          ...
          <Button
            onClick={() => load(1)}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#8C7B6E] px-4 py-2 text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] text-white shadow-md shadow-[#8C7B6E]/30 transition-all hover:bg-[#7a6a5a] hover:shadow-lg whitespace-normal"
          >
            <Search size={14} />
            Buscar
          </Button>
