...
export default async function DashboardPage() {
  ...
  const [livrosRes, encontrosRes, colabsRes, empreendedorasRes, resenhasRes] = await Promise.all([
  ...
  const cards = [
    { label: 'Livros do Mês', value: stats.livros, color: 'border-l-[#B04D4A]', icon: Book, href: '/admin/livro-do-mes', desc: 'Acervo curado' },
    ...
    { label: 'Escritoras', value: stats.livros, color: 'border-l-[#6B705C]', icon: PenTool, href: '/admin/escritoras', desc: 'Autoras catalogadas' },
