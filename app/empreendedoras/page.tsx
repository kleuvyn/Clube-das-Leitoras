    ...
    <div className="min-h-screen font-alice pb-40 relative overflow-hidden"
      ...
      <main className="max-w-7xl mx-auto px-6 pt-24 space-y-48">
        ...
        <div className="mb-12 flex flex-wrap gap-3 items-center justify-center">
          <button
            className={`px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest border transition-all ${categoriaSelecionada === "Todas" ? "bg-[#967BB6] text-white border-[#967BB6]" : "bg-white text-[#967BB6] border-[#967BB6] hover:bg-[#967BB6] hover:text-white"}`}
          ...
          {CATEGORIAS.map(cat => (
            <button
              key={cat}
              className={`px-6 py-2 rounded-full text-xs font-bold uppercase tracking-widest border transition-all ${categoriaSelecionada === cat ? "bg-[#967BB6] text-white border-[#967BB6]" : "bg-white text-[#967BB6] border-[#967BB6] hover:bg-[#967BB6] hover:text-white"}`}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-12 gap-y-24">
            {empreendedoras
              .filter(item => categoriaSelecionada === "Todas" || item.categoria === categoriaSelecionada)
              .map((item, idx) => (
